        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_StudentUsers_StudentUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_Date_StartTime",
                table: "Reservations",
                columns: new[] { "Date", "StartTime" });

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_SeatId_Date",
                table: "Reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seats_Area_Floor",
                table: "Seats",
                columns: new[] { "Area", "Floor" });
        }
